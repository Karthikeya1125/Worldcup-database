...
CREATE TABLE public.games (
    ...
    round character varying(1000) NOT NULL,
...
--
-- Name: games games_winner_goals_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT games_winner_goals_fkey FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
